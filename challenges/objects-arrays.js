...
console.log(dinosaurs.tyrannosaurus.speak('RAWERSRARARWERSARARARRRR!'));
...
const uni = graduates
  .filter(school => {
    return school.university.match(/Uni/);
  })
  .map(school => {
...
const populationTotal = zooAnimals.reduce((runningTotal, animal) => {
