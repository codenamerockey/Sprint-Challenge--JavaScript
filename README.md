...
The biggest difference between forEach and Map is that Map returns an Array and forEach does not return anything, also Map manipulates the array into a completely different array while forEach just loops through the array and performs a function on each item in the array.
...
super() is needed in a extended class because it tells a parent’s constructor to be concerned with the child’s attributes and vice versa meaning the child also has access to the parents attributes.
